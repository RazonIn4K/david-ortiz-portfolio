...
class PerformanceOptimizer {
  ...
  setupResourcePreloading() {
    ...
    const criticalResources = [
      { href: '/src/js/script.js', rel: 'modulepreload' },
      { href: '/src/css/styles.css', rel: 'preload', as: 'style' },
      { href: '/assets/david-ortiz-avatar.svg', rel: 'preload', as: 'image' }
    ];
    criticalResources.forEach(resource => {
      ...
      if (resource.rel === 'preload' && resource.as === 'script') {
