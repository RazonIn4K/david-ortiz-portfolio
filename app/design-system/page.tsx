    ...
    <div className="design-system-page min-h-screen bg-neutral-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-700">David Ortiz Ecosystem</p>
            </div>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Shared design tokens, reusable components, and site-specific animations for davidtiz.com, HighEncode,
            CSBrainAI, and Prompt Defenders.
          </motion.p>
      ...
      <footer className="py-12 px-6 border-t border-neutral-200">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-neutral-700">
            Powering davidtiz.com, highencodelearning.com, csbrainai.vercel.app, and prompt-defenders.vercel.app
          </p>
        </div>
      </footer>
    </div>
