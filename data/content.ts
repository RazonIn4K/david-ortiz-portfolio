...
export const services: Service[] = [
  {
    ...
    description: 'I build intelligent n8n & Make workflows that handle lead qualification, research, and CRM sync automatically.',
    bullets: [
    ...
    icon: '⚙️',
    cta: {
      label: 'View Automation Gigs',
      href: 'https://www.fiverr.com/davido174'
    }
  },
  {
    title: 'Custom RAG Chatbots',
    description: 'Deploy AI assistants that know your business. Trained on your PDFs, docs, and website data.',
    bullets: [
      'Customer Support Bots',
      'Internal SOP Assistants',
      'Multi-platform (Web/Slack)'
    ],
    icon: '💬',
    cta: {
      label: 'View Chatbot Gigs',
      href: 'https://www.fiverr.com/davido174'
    }
  },
  {
    title: 'SaaS Security Audits',
    description: 'Ethical security checkups for your SaaS or website. Identify vulnerabilities before they become problems.',
    bullets: [
      'OSINT Footprint Reports',
      'Go-Live Security Gates',
      'Vulnerability Assessments'
    ],
    icon: '🛡️',
    cta: {
      label: 'View Security Gigs',
      href: 'https://www.fiverr.com/davido174'
    }
  },
  {
    title: 'AI Video & UGC',
    description: 'High-tech explainer videos and social ads generated by AI. Perfect for SaaS launches and viral marketing.',
    bullets: [
      'AI Explainer Videos',
      'Social Media Ads',
      'Script-to-Video'
