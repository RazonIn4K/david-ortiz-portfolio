...
export function FloatingDock() {
  ...
  return (
    ...
    >
      <div
        className="glass-strong rounded-2xl px-4 py-3 flex items-center gap-1"
        role="list"
      >
        {dockItems.map((item, i) => {
          const isActive = focusedIndex === i;
          const isNear =
            focusedIndex !== null && Math.abs(focusedIndex - i) === 1;
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                transition={
                  prefersReducedMotion ? { duration: 0.1 } : undefined
                }
