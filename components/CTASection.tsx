  ...
  return (
    <section className="bg-navy py-20 lg:py-28" id="contact">
      <div className="mx-auto max-w-4xl px-4">
        <GlassmorphismCard className="px-6 py-12 text-center lg:px-12">
          ...
          <p className="mt-6 text-xs text-white/60">
            ...
            <Link href={UPWORK_URL} target="_blank" className="text-teal-400 underline transition-colors duration-300 hover:text-teal-300">
