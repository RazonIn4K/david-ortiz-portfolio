      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[#6b7280] text-sm leading-relaxed mb-4">
              Personal notes, experiments, and systems thinking across browsers,
              APIs, automation, and delivery.
            </p>
            <Link
              href="/#focus"
          ...
          {/* Themes Column */}
          <div>
            <h4 className="text-[#111827] text-xs font-semibold uppercase tracking-wider mb-4">
              Themes
            </h4>
              ...
              {footerEcosystemLinks.map((item) => (
                <li key={item.label}>
                  ...
                  >
                    ...
                    <span className="text-xs text-[#9ca3af] group-hover:text-[#3b82f6]/70">
                      {item.description}
                    </span>
                  </a>
                </li>
            ...
            <ul className="space-y-3">
              {footerPrimaryLinks.map((item) => (
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="text-[#6b7280] hover:text-[#3b82f6] transition-colors text-sm"
                  >
                    {item.label}
                  </a>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-[#e5e7eb] flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-xs text-[#9ca3af]">
            <a
              href="https://highencodelearning.com/privacy"
              className="hover:text-[#6b7280] transition-colors"
            >
              Business Privacy
            </a>
            <a
              href="https://highencodelearning.com/terms"
              className="hover:text-[#6b7280] transition-colors"
            >
              Business Terms
            </a>
